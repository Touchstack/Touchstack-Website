...
const FindUs = () => {
  return ( <section className="bg-cover bg-no-repeat bg-[url('src/assets/images/bg-contact.png')] rounded-none">
      ...
      <div className="lg:mx-0 md:mx-auto mx-auto">
        <form>
          <div className="grid gap-6 mb-6 md:grid-cols-1">
            <div>
              <label htmlFor="first_name" className="block mb-2 text-base text-white font-EncodeBold">Your Name</label>
              <input
                type="text"
                id="first_name"
            ...
            <div className="mb-6">
              <label htmlFor="email" className="block mb-2 text-base text-white font-EncodeBold dark:text-white">Email</label>
              <input
                type="email"
                id="email"
                className="bg-inherit border border-gray-300 text-white focus:border-green-300 focus:ring-1 focus:outline-none focus:ring-green-300 text-sm rounded-lg block w-80 p-4"
            ...
            <div>
              <label htmlFor="website" className="block mb-2 text-base text-white focus:border-green-300 focus:ring-1 focus:outline-none focus:ring-green-300 font-EncodeBold dark:text-white">Your message</label>
              <textarea
                id="website"
          ...
          <div className="mb-6">
            <label htmlFor="email" className="block mb-2 text-base text-white font-EncodeBold dark:text-white">How did you hear about us ?</label>
            <select
              id="countries"
              className="bg-inherit border border-gray-300 text-white focus:border-green-300 focus:ring-1 focus:outline-none focus:ring-green-300 text-sm rounded-lg block w-80 p-4"
            >
  ...
  <div className="grid lg:grid-cols-3 grid-cols-1 gap-8 pb-24 lg:px-32">
    ...
    <div className="lg:text-left md:text-center text-center">
      ...
      <a href="tel:+233 20 376 7382" className="mb-6 text-lg font-EncodeMedium hover:text-green-400 hover:underline text-gray-500 lg:text-xl dark:text-gray-400">
        +233 20 376 7382
      </a>
    </div>
    <div className="lg:text-left md:text-center text-center">
      ...
      <a href="mailto:info@touchstacktecnologies.com" className="mb-6 text-lg hover:text-green-400 underline font-EncodeMedium text-gray-500 lg:text-xl dark:text-gray-400">
