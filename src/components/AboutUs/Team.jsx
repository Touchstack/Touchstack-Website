...
const Team = () => (
  <div className="grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 lg:gap-0 md:gap-24 gap-24 lg:p-0 md:p-12 p-8">
    <TeamMember
    ...
    <TeamMember
      ...
      imageSrc={Bernice}
      linkedInLink="https://www.linkedin.com/in/bernice-otoo-767a42295/"
    />
    <TeamMember
      name="Jemima Cole"
