...
<path d="M20 11.5C21.5913 11.5 23.1174 12.1321 24.2426 13.2574C25.3679 14.3826 26 15.9087 26 17.5V24.5H22V17.5C22 16.9696 21.7893 16.4609 21.4142 16.0858C21.0391 15.7107 20.5304 15.5 20 15.5C19.4696 15.5 18.9609 15.7107 18.5858 16.0858C18.2107 16.4609 18 16.9696 18 17.5V24.5H14V17.5C14 15.9087 14.6321 14.3826 15.7574 13.2574C16.8826 12.1321 18.4087 11.5 20 11.5V11.5Z" stroke="#292A2C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M10 12.5H6V24.5H10V12.5Z" stroke="#292A2C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8 9.5C9.10457 9.5 10 8.60457 10 7.5C10 6.39543 9.10457 5.5 8 5.5C6.89543 5.5 6 6.39543 6 7.5C6 8.60457 6.89543 9.5 8 9.5Z" stroke="#292A2C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>}
    </a>
  </div>
);
